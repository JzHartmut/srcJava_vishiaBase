...
public abstract class FileRemoteProgress extends EventConsumerAwait {
   ...
   * @return 
   */
  protected abstract int processEvent(FileRemoteProgressEvData progress, EventWithDst<FileRemoteCmdEventData, ?> evCmd);
  ...
  @Override public final int processEvent(EventObject evRaw) {
    EventWithDst<FileRemoteProgressEvData, FileRemoteCmdEventData> ev = (EventWithDst<FileRemoteProgressEvData, FileRemoteCmdEventData>) evRaw;
