...
* The basic idea in that time was, the control characters for the syntax should be immediately and simple given.
...
One is: colored syntax: The syntax control characters are presented in another background color.
...
For plain text, another approach is used:
