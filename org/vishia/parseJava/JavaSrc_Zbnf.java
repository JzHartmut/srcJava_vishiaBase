...
public class JavaSrc_Zbnf {
  ...
  public static class ClassDefinition_Zbnf implements SetLineColumn_ifc {
    ...
    public void add_enumDefinition(EnumDefinition_Zbnf val) {
      if(dataClassDefinition.enumDefinition==null) { dataClassDefinition.enumDefinition = new LinkedList<JavaSrc.EnumDefinition>(); }
      dataClassDefinition.enumDefinition.add(val.dataEnumDefinition); 
    }
    ...
    /**Add the result to the list. &lt;ClassDefinition?classDefinition&gt;*/
    public void add_classDefinition(ClassDefinition_Zbnf val) {
      if(dataClassDefinition.classDefinition==null) { dataClassDefinition.classDefinition = new LinkedList<JavaSrc.ClassDefinition>(); }
      dataClassDefinition.classDefinition.add(val.dataClassDefinition); 
    }
    ...
    /**Add the result to the list. &lt;InterfaceDefinition?interfaceDefinition&gt;*/
    public void add_interfaceDefinition(InterfaceDefinition_Zbnf val) {
      if(dataClassDefinition.interfaceDefinition==null) { dataClassDefinition.interfaceDefinition = new LinkedList<JavaSrc.InterfaceDefinition>(); }
      dataClassDefinition.interfaceDefinition.add(val.dataInterfaceDefinition); 
    }
    ...
    public void add_variableDefinition(VariableInstance_Zbnf val) {
      if(dataClassDefinition.variableDefinition==null) { dataClassDefinition.variableDefinition = new LinkedList<JavaSrc.VariableInstance>(); }
      dataClassDefinition.variableDefinition.add(val.dataVariableInstance); 
    }
    ...
    public void add_methodDefinition(MethodDefinition_Zbnf val) {
      if(dataClassDefinition.methodDefinition==null) { dataClassDefinition.methodDefinition = new LinkedList<JavaSrc.MethodDefinition>(); }
      dataClassDefinition.methodDefinition.add(val.dataMethodDefinition); 
    }
    ...
    public void add_constructorDefinition(ConstructorDefinition_Zbnf val) {
      if(dataClassDefinition.constructorDefinition==null) { dataClassDefinition.constructorDefinition = new LinkedList<JavaSrc.ConstructorDefinition>(); }
      dataClassDefinition.constructorDefinition.add(val.dataConstructorDefinition); 
    }
    ...
    /**Add the result to the list. &lt;AnnotationDefinition?annotationDefinition&gt;*/
    public void add_annotationDefinition(AnnotationDefinition_Zbnf val) {
      if(dataClassDefinition.annotationDefinition==null) { dataClassDefinition.annotationDefinition = new LinkedList<JavaSrc.AnnotationDefinition>(); }
      dataClassDefinition.annotationDefinition.add(val.dataAnnotationDefinition); 
    }
    ...
    public void add_initializingBlockStatic(StatementBlock_Zbnf val) {
      if(dataClassDefinition.initializingBlockStatic==null) { dataClassDefinition.initializingBlockStatic = new LinkedList<JavaSrc.StatementBlock>(); }
      dataClassDefinition.initializingBlockStatic.add(val.dataStatementBlock); 
    }
    ...
    public void add_initializingBlock(StatementBlock_Zbnf val) {
      if(dataClassDefinition.initializingBlock==null) { dataClassDefinition.initializingBlock = new LinkedList<JavaSrc.StatementBlock>(); }
      dataClassDefinition.initializingBlock.add(val.dataStatementBlock); 
    }
  ...
  public static class Java4CAnnotationMethod_Zbnf implements SetLineColumn_ifc {
    ...
    public void set_exclude(String val) { this.dataJava4CAnnotationMethod.exclude = val; }
    
    
    /**Set routine for the singular component &lt;String?excludeImpl>. */
    public void set_excludeImpl(String val) { this.dataJava4CAnnotationMethod.excludeImpl = val; }
    
    
    /**Set routine for the singular component &lt;String?extendsOnlyMethods>. */
    public void set_extendsOnlyMethods(String val) { this.dataJava4CAnnotationMethod.extendsOnlyMethods = val; }
    
    
    /**Set routine for the singular component &lt;String?inline>. */
    public void set_inline(String val) { this.dataJava4CAnnotationMethod.inline = val; }
    
    
    /**Set routine for the singular component &lt;String?retinline>. */
    public void set_retinline(String val) { this.dataJava4CAnnotationMethod.retinline = val; }
    
    
    /**Set routine for the singular component &lt;String?ReturnThis>. */
    public void set_ReturnThis(String val) { this.dataJava4CAnnotationMethod.returnThis = val; }
    
    
    /**Set routine for the singular component &lt;String?ReturnNew>. */
    public void set_ReturnNew(String val) { this.dataJava4CAnnotationMethod.returnNew = val; }
    
    
    /**Set routine for the singular component &lt;String?ReturnInThreadCxt>. */
    public void set_ReturnInThreadCxt(String val) { this.dataJava4CAnnotationMethod.returnInThreadCxt = val; }
    
    
    /**Set routine for the singular component &lt;String?dynamic_call>. */
    public void set_dynamic_call(String val) { this.dataJava4CAnnotationMethod.dynamic_call = val; }
    
    
    /**Set routine for the singular component &lt;String?xxxoverride_able>. */
    public void set_xxxoverride_able(String val) { this.dataJava4CAnnotationMethod.xxxoverride_able = val; }
    
    
    /**Set routine for the singular component &lt;String?noThCxt>. */
    public void set_noThCxt(String val) { this.dataJava4CAnnotationMethod.noThCxt = val; }
    
    
    /**Set routine for the singular component &lt;String?noStacktrace>. */
    public void set_noStacktrace(String val) { this.dataJava4CAnnotationMethod.noStacktrace = val; }
  ...
  public static class Java4CAnnotationType_Zbnf implements SetLineColumn_ifc {
    ...
    public void set_noGC(String val) { this.dataJava4CAnnotationType.noGC = val; }
    
    
    /**Set routine for the singular component &lt;String?simpleVariableRef>. */
    public void set_simpleVariableRef(String val) { this.dataJava4CAnnotationType.simpleVariableRef = val; }
    
    
    /**Set routine for the singular component &lt;String?simpleArray>. */
    public void set_simpleArray(String val) { this.dataJava4CAnnotationType.simpleArray = val; }
    
    
    /**Set routine for the singular component &lt;String?PtrVal>. */
    public void set_PtrVal(String val) { this.dataJava4CAnnotationType.ptrVal = val; }
    
    
    /**Set routine for the singular component &lt;String?embeddedYElements>. */
    public void set_embeddedYElements(String val) { this.dataJava4CAnnotationType.embeddedYElements = val; }
    
    
    /**Set routine for the singular component &lt;String?zeroTermString>. */
    public void set_zeroTermString(String val) { this.dataJava4CAnnotationType.zeroTermString = val; }
    
    
    /**Set routine for the singular component &lt;String?ByteStringJc>. */
    public void set_ByteStringJc(String val) { this.dataJava4CAnnotationType.byteStringJc = val; }
    
    
    /**Set routine for the singular component &lt;String?StringJc>. */
    public void set_StringJc(String val) { this.dataJava4CAnnotationType.stringJc = val; }
  ...
  public static class Java4CAnnotationVariable_Zbnf implements SetLineColumn_ifc {
    ...
    public void set_excludeCond(String val) { this.dataJava4CAnnotationVariable.excludeCond = val; }
    
    
    /**Set routine for the singular component &lt;String?exclude>. */
    public void set_exclude(String val) { this.dataJava4CAnnotationVariable.exclude = val; }
    
    
    /**Set routine for the singular component &lt;String?embeddedData>. */
    public void set_embeddedData(String val) { this.dataJava4CAnnotationVariable.embeddedData = val; }
    
    
    /**Set routine for the singular component &lt;String?dynamic_call>. */
    public void set_dynamic_call(String val) { this.dataJava4CAnnotationVariable.dynamic_call = val; }
    
    
    /**Set routine for the singular component &lt;String?staticInstance>. */
    public void set_staticInstance(String val) { this.dataJava4CAnnotationVariable.staticInstance = val; }
    
    
    /**Set routine for the singular component &lt;String?nonPersistent>. */
    public void set_nonPersistent(String val) { this.dataJava4CAnnotationVariable.nonPersistent = val; }
    
    
    /**Set routine for the singular component &lt;String?stackInstance>. */
    public void set_stackInstance(String val) { this.dataJava4CAnnotationVariable.stackInstance = val; }
    ...
    public void set_toStringNonPersist(String val) { this.dataJava4CAnnotationVariable.toStringNonPersist = val; }
    
    
    /**Set routine for the singular component &lt;String?declarePersist>. */
    public void set_declarePersist(String val) { this.dataJava4CAnnotationVariable.declarePersist = val; }
    ...
    /**Set routine for the singular component &lt;String?ReturnInThreadCxt>. */
    public void set_ReturnInThreadCxt(String val) { this.dataJava4CAnnotationVariable.returnInThreadCxt = val; }
  ...
  public static class ModifierMethod_Zbnf implements SetLineColumn_ifc {
    ...
    /**Set routine for the singular component &lt;String?noGC>. */
    public void set_noGC(String val) { this.dataModifierMethod.noGC = val; }
    
    
    /**Set routine for the singular component &lt;String?simpleVariableRef>. */
    public void set_simpleVariableRef(String val) { this.dataModifierMethod.simpleVariableRef = val; }
    
    
    /**Set routine for the singular component &lt;String?simpleArray>. */
    public void set_simpleArray(String val) { this.dataModifierMethod.simpleArray = val; }
    
    
    /**Set routine for the singular component &lt;String?PtrVal>. */
    public void set_PtrVal(String val) { this.dataModifierMethod.ptrVal = val; }
    
    
    /**Set routine for the singular component &lt;String?embeddedYElements>. */
    public void set_embeddedYElements(String val) { this.dataModifierMethod.embeddedYElements = val; }
    
    
    /**Set routine for the singular component &lt;String?zeroTermString>. */
    public void set_zeroTermString(String val) { this.dataModifierMethod.zeroTermString = val; }
    
    
    /**Set routine for the singular component &lt;String?ByteStringJc>. */
    public void set_ByteStringJc(String val) { this.dataModifierMethod.byteStringJc = val; }
    
    
    /**Set routine for the singular component &lt;String?StringJc>. */
    public void set_StringJc(String val) { this.dataModifierMethod.stringJc = val; }
    
    
    /**Set routine for the singular component &lt;String?exclude>. */
    public void set_exclude(String val) { this.dataModifierMethod.exclude = val; }
    
    
    /**Set routine for the singular component &lt;String?excludeImpl>. */
    public void set_excludeImpl(String val) { this.dataModifierMethod.excludeImpl = val; }
    
    
    /**Set routine for the singular component &lt;String?extendsOnlyMethods>. */
    public void set_extendsOnlyMethods(String val) { this.dataModifierMethod.extendsOnlyMethods = val; }
    
    
    /**Set routine for the singular component &lt;String?inline>. */
    public void set_inline(String val) { this.dataModifierMethod.inline = val; }
    
    
    /**Set routine for the singular component &lt;String?retinline>. */
    public void set_retinline(String val) { this.dataModifierMethod.retinline = val; }
    
    
    /**Set routine for the singular component &lt;String?ReturnThis>. */
    public void set_ReturnThis(String val) { this.dataModifierMethod.returnThis = val; }
    
    
    /**Set routine for the singular component &lt;String?ReturnNew>. */
    public void set_ReturnNew(String val) { this.dataModifierMethod.returnNew = val; }
    
    
    /**Set routine for the singular component &lt;String?ReturnInThreadCxt>. */
    public void set_ReturnInThreadCxt(String val) { this.dataModifierMethod.returnInThreadCxt = val; }
    
    
    /**Set routine for the singular component &lt;String?dynamic_call>. */
    public void set_dynamic_call(String val) { this.dataModifierMethod.dynamic_call = val; }
    
    
    /**Set routine for the singular component &lt;String?xxxoverride_able>. */
    public void set_xxxoverride_able(String val) { this.dataModifierMethod.xxxoverride_able = val; }
    
    
    /**Set routine for the singular component &lt;String?noThCxt>. */
    public void set_noThCxt(String val) { this.dataModifierMethod.noThCxt = val; }
    
    
    /**Set routine for the singular component &lt;String?noStacktrace>. */
    public void set_noStacktrace(String val) { this.dataModifierMethod.noStacktrace = val; }
  ...
  public static class ModifierVariable_Zbnf implements SetLineColumn_ifc {
    ...
    /**Set routine for the singular component &lt;String?accessPlolicy>. */
    public void set_accessPlolicy(String val) { this.dataModifierVariable.accessPlolicy = val; }
    ...
    /**Set routine for the singular component &lt;String?excludeCond>. */
    public void set_excludeCond(String val) { this.dataModifierVariable.excludeCond = val; }
    
    
    /**Set routine for the singular component &lt;String?exclude>. */
    public void set_exclude(String val) { this.dataModifierVariable.exclude = val; }
    
    
    /**Set routine for the singular component &lt;String?embeddedData>. */
    public void set_embeddedData(String val) { this.dataModifierVariable.embeddedData = val; }
    
    
    /**Set routine for the singular component &lt;String?dynamic_call>. */
    public void set_dynamic_call(String val) { this.dataModifierVariable.dynamic_call = val; }
    
    
    /**Set routine for the singular component &lt;String?staticInstance>. */
    public void set_staticInstance(String val) { this.dataModifierVariable.staticInstance = val; }
    
    
    /**Set routine for the singular component &lt;String?nonPersistent>. */
    public void set_nonPersistent(String val) { this.dataModifierVariable.nonPersistent = val; }
    
    
    /**Set routine for the singular component &lt;String?stackInstance>. */
    public void set_stackInstance(String val) { this.dataModifierVariable.stackInstance = val; }
    
    
    /**Set routine for the singular component &lt;String?InstanceType>. */
    public void set_InstanceType(String val) { this.dataModifierVariable.instanceType = val; }
    
    
    /**Set routine for the singular component &lt;String?toStringNonPersist>. */
    public void set_toStringNonPersist(String val) { this.dataModifierVariable.toStringNonPersist = val; }
    
    
    /**Set routine for the singular component &lt;String?declarePersist>. */
    public void set_declarePersist(String val) { this.dataModifierVariable.declarePersist = val; }
    
    
    /**Set routine for the singular component &lt;int?StringBuilderInStack>. */
    public void set_StringBuilderInStack(int val) { this.dataModifierVariable.stringBuilderInStack = val; }
    
    
    /**Set routine for the singular component &lt;String?StringBuilderInThCxt>. */
    public void set_StringBuilderInThCxt(String val) { this.dataModifierVariable.stringBuilderInThCxt = val; }
    
    
    /**Set routine for the singular component &lt;String?InThCxtRet>. */
    public void set_InThCxtRet(String val) { this.dataModifierVariable.inThCxtRet = val; }
    
    
    /**Set routine for the singular component &lt;String?InThCxtLocal>. */
    public void set_InThCxtLocal(String val) { this.dataModifierVariable.inThCxtLocal = val; }
    
    
    /**Set routine for the singular component &lt;String?ReturnInThreadCxt>. */
    public void set_ReturnInThreadCxt(String val) { this.dataModifierVariable.returnInThreadCxt = val; }
    
    
    /**Set routine for the singular component &lt;int?fixArraySize>. */
    public void set_fixArraySize(int val) { this.dataModifierVariable.fixArraySize = val; }
    
    
    /**Set routine for the singular component &lt;String?noGC>. */
    public void set_noGC(String val) { this.dataModifierVariable.noGC = val; }
    
    
    /**Set routine for the singular component &lt;String?simpleVariableRef>. */
    public void set_simpleVariableRef(String val) { this.dataModifierVariable.simpleVariableRef = val; }
    
    
    /**Set routine for the singular component &lt;String?simpleArray>. */
    public void set_simpleArray(String val) { this.dataModifierVariable.simpleArray = val; }
    
    
    /**Set routine for the singular component &lt;String?PtrVal>. */
    public void set_PtrVal(String val) { this.dataModifierVariable.ptrVal = val; }
    
    
    /**Set routine for the singular component &lt;String?embeddedYElements>. */
    public void set_embeddedYElements(String val) { this.dataModifierVariable.embeddedYElements = val; }
    
    
    /**Set routine for the singular component &lt;String?zeroTermString>. */
    public void set_zeroTermString(String val) { this.dataModifierVariable.zeroTermString = val; }
    
    
    /**Set routine for the singular component &lt;String?ByteStringJc>. */
    public void set_ByteStringJc(String val) { this.dataModifierVariable.byteStringJc = val; }
    
    
    /**Set routine for the singular component &lt;String?StringJc>. */
    public void set_StringJc(String val) { this.dataModifierVariable.stringJc = val; }
    
    
    /**Set routine for the singular component &lt;String?Annotation>. */
    public void set_Annotation(String val) { this.dataModifierVariable.annotation = val; }
  ...
  public static class EnumDefinition_Zbnf implements SetLineColumn_ifc {
    ...
    /**Add the result to the list. &lt;EnumDefinition?enumDefinition&gt;*/
    public void add_enumDefinition(EnumDefinition_Zbnf val) {
      if(dataEnumDefinition.enumDefinition==null) { dataEnumDefinition.enumDefinition = new LinkedList<JavaSrc.EnumDefinition>(); }
      dataEnumDefinition.enumDefinition.add(val.dataEnumDefinition); 
    }
    ...
    /**Add the result to the list. &lt;ClassDefinition?classDefinition&gt;*/
    public void add_classDefinition(ClassDefinition_Zbnf val) {
      if(dataEnumDefinition.classDefinition==null) { dataEnumDefinition.classDefinition = new LinkedList<JavaSrc.ClassDefinition>(); }
      dataEnumDefinition.classDefinition.add(val.dataClassDefinition); 
    }
    ...
    /**Add the result to the list. &lt;InterfaceDefinition?interfaceDefinition&gt;*/
    public void add_interfaceDefinition(InterfaceDefinition_Zbnf val) {
      if(dataEnumDefinition.interfaceDefinition==null) { dataEnumDefinition.interfaceDefinition = new LinkedList<JavaSrc.InterfaceDefinition>(); }
      dataEnumDefinition.interfaceDefinition.add(val.dataInterfaceDefinition); 
    }
    ...
    /**Add the result to the list. &lt;VariableInstance?variableDefinition&gt;*/
    public void add_variableDefinition(VariableInstance_Zbnf val) {
      if(dataEnumDefinition.variableDefinition==null) { dataEnumDefinition.variableDefinition = new LinkedList<JavaSrc.VariableInstance>(); }
      dataEnumDefinition.variableDefinition.add(val.dataVariableInstance); 
    }
    ...
    /**Add the result to the list. &lt;MethodDefinition?methodDefinition&gt;*/
    public void add_methodDefinition(MethodDefinition_Zbnf val) {
      if(dataEnumDefinition.methodDefinition==null) { dataEnumDefinition.methodDefinition = new LinkedList<JavaSrc.MethodDefinition>(); }
      dataEnumDefinition.methodDefinition.add(val.dataMethodDefinition); 
    }
    ...
    /**Add the result to the list. &lt;ConstructorDefinition?constructorDefinition&gt;*/
    public void add_constructorDefinition(ConstructorDefinition_Zbnf val) {
      if(dataEnumDefinition.constructorDefinition==null) { dataEnumDefinition.constructorDefinition = new LinkedList<JavaSrc.ConstructorDefinition>(); }
      dataEnumDefinition.constructorDefinition.add(val.dataConstructorDefinition); 
    }
    ...
    /**Add the result to the list. &lt;AnnotationDefinition?annotationDefinition&gt;*/
    public void add_annotationDefinition(AnnotationDefinition_Zbnf val) {
      if(dataEnumDefinition.annotationDefinition==null) { dataEnumDefinition.annotationDefinition = new LinkedList<JavaSrc.AnnotationDefinition>(); }
      dataEnumDefinition.annotationDefinition.add(val.dataAnnotationDefinition); 
    }
    ...
    /**Add the result to the list. &lt;StatementBlock?initializingBlockStatic&gt;*/
    public void add_initializingBlockStatic(StatementBlock_Zbnf val) {
      if(dataEnumDefinition.initializingBlockStatic==null) { dataEnumDefinition.initializingBlockStatic = new LinkedList<JavaSrc.StatementBlock>(); }
      dataEnumDefinition.initializingBlockStatic.add(val.dataStatementBlock); 
    }
    ...
    /**Add the result to the list. &lt;StatementBlock?initializingBlock&gt;*/
    public void add_initializingBlock(StatementBlock_Zbnf val) {
      if(dataEnumDefinition.initializingBlock==null) { dataEnumDefinition.initializingBlock = new LinkedList<JavaSrc.StatementBlock>(); }
      dataEnumDefinition.initializingBlock.add(val.dataStatementBlock); 
    }
  ...
  public static class Test_description_Zbnf implements SetLineColumn_ifc {
    ...
    public void set_sizeofDescription(String val) { 
      if(dataTest_description.sizeofDescription==null) { dataTest_description.sizeofDescription = new LinkedList<String>(); }
      dataTest_description.sizeofDescription.add(val); 
    }
    ...
    public void add_returnDescription(ReturnDescription_Zbnf val) {
      if(dataTest_description.returnDescription==null) { dataTest_description.returnDescription = new LinkedList<JavaSrc.ReturnDescription>(); }
      dataTest_description.returnDescription.add(val.dataReturnDescription); 
    }
    ...
    public void set_staticInstance(String val) { 
      if(dataTest_description.staticInstance==null) { dataTest_description.staticInstance = new LinkedList<String>(); }
      dataTest_description.staticInstance.add(val); 
    }
    ...
    public void set_excludeCond(String val) { 
      if(dataTest_description.excludeCond==null) { dataTest_description.excludeCond = new LinkedList<String>(); }
      dataTest_description.excludeCond.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?exclude>. */
    public void set_exclude(String val) { 
      if(dataTest_description.exclude==null) { dataTest_description.exclude = new LinkedList<String>(); }
      dataTest_description.exclude.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?embeddedData>. */
    public void set_embeddedData(String val) { 
      if(dataTest_description.embeddedData==null) { dataTest_description.embeddedData = new LinkedList<String>(); }
      dataTest_description.embeddedData.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?InstanceType>. */
    public void set_InstanceType(String val) { 
      if(dataTest_description.instanceType==null) { dataTest_description.instanceType = new LinkedList<String>(); }
      dataTest_description.instanceType.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?StringBuilderInThCxt>. */
    public void set_StringBuilderInThCxt(String val) { 
      if(dataTest_description.stringBuilderInThCxt==null) { dataTest_description.stringBuilderInThCxt = new LinkedList<String>(); }
      dataTest_description.stringBuilderInThCxt.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?InThCxtRet>. */
    public void set_InThCxtRet(String val) { 
      if(dataTest_description.inThCxtRet==null) { dataTest_description.inThCxtRet = new LinkedList<String>(); }
      dataTest_description.inThCxtRet.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?InThCxtLocal>. */
    public void set_InThCxtLocal(String val) { 
      if(dataTest_description.inThCxtLocal==null) { dataTest_description.inThCxtLocal = new LinkedList<String>(); }
      dataTest_description.inThCxtLocal.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?ReturnInThreadCxt>. */
    public void set_ReturnInThreadCxt(String val) { 
      if(dataTest_description.returnInThreadCxt==null) { dataTest_description.returnInThreadCxt = new LinkedList<String>(); }
      dataTest_description.returnInThreadCxt.add(val); 
    }
    ...
    public void set_PtrVal(String val) { 
      if(dataTest_description.ptrVal==null) { dataTest_description.ptrVal = new LinkedList<String>(); }
      dataTest_description.ptrVal.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?StringJc>. */
    public void set_StringJc(String val) { 
      if(dataTest_description.stringJc==null) { dataTest_description.stringJc = new LinkedList<String>(); }
      dataTest_description.stringJc.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?excludeImpl>. */
    public void set_excludeImpl(String val) { 
      if(dataTest_description.excludeImpl==null) { dataTest_description.excludeImpl = new LinkedList<String>(); }
      dataTest_description.excludeImpl.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?extendsOnlyMethods>. */
    public void set_extendsOnlyMethods(String val) { 
      if(dataTest_description.extendsOnlyMethods==null) { dataTest_description.extendsOnlyMethods = new LinkedList<String>(); }
      dataTest_description.extendsOnlyMethods.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?inline>. */
    public void set_inline(String val) { 
      if(dataTest_description.inline==null) { dataTest_description.inline = new LinkedList<String>(); }
      dataTest_description.inline.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?retinline>. */
    public void set_retinline(String val) { 
      if(dataTest_description.retinline==null) { dataTest_description.retinline = new LinkedList<String>(); }
      dataTest_description.retinline.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?ReturnThis>. */
    public void set_ReturnThis(String val) { 
      if(dataTest_description.returnThis==null) { dataTest_description.returnThis = new LinkedList<String>(); }
      dataTest_description.returnThis.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?ReturnNew>. */
    public void set_ReturnNew(String val) { 
      if(dataTest_description.returnNew==null) { dataTest_description.returnNew = new LinkedList<String>(); }
      dataTest_description.returnNew.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?instanceTypeAnnot>. */
    public void set_instanceTypeAnnot(String val) { 
      if(dataTest_description.instanceTypeAnnot==null) { dataTest_description.instanceTypeAnnot = new LinkedList<String>(); }
      dataTest_description.instanceTypeAnnot.add(val); 
    }
    
    
    /**Set routine for the singular component &lt;String?embeddedTypeAnnot>. */
    public void set_embeddedTypeAnnot(String val) { 
      if(dataTest_description.embeddedTypeAnnot==null) { dataTest_description.embeddedTypeAnnot = new LinkedList<String>(); }
      dataTest_description.embeddedTypeAnnot.add(val); 
    }
