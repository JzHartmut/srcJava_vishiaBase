...
public final class ZGenSyntax {
  ...
  public final static String syntax =
    ...
    + "  | break | XXXreturn | exit | onerror | for | while | do | if | elsif | else . \n"
    + "\n"
    + "ZGen::= \n"
    + "[<*|==ZGen==?>==ZGen== ]\n"
    ...
    + "\n"
    + "ifBlockInText::= <conditionInText> \\> <textExpr>.\n"
    + "\n"
    ...
    + "\n"
    + "\n"
    + "onerror::= [<#?errorLevel> | [<?errortype> notfound | file | internal | exit [<#?errorLevel>] ]|] \n" 
    + "\\{ <statementBlock> \\}.\n"
    + "\n"
