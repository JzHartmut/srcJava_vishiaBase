...
public final class JZcmdSyntax {
  ...
  public final static String syntax =
    ...
    + " \n"
    + " value::= <#?intValue>[?\\.] | <#f?doubleValue> |    ##unary - associated to value.\n"
    ...
    + " \n"
    + " \n"
    + " zmake::= [ : <$-?name> :[?=] ] <output> := <textValue?callName> ( { <namedArgument?actualArgument> | <zmakeInput> ? ,} ).\n"
    + " \n"
    + " output::=<*|\\ |\\r|\\n|:=?!prepFilePath>.\n"
    + " \n"
    //+ " zmakeInput::= [ & [ $<$?accessPathEnvirVariable> | <$?accessPathOrFilesetVariable>] |\n"
    + " zmakeInput::= [ \n"
