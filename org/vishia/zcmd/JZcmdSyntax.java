...
public final class JZcmdSyntax {
  ...
  public final static String syntax =
    ...
    + " \n"
    + " \n"
    + " textDatapath::=  <\"\"?text> | <checkTextExpr?textExpr> | [& [?(] ] <dataAccess> .\n"
    + " \n"
    + " textValue::=  <\"\"?text> | <checkTextExpr?textExpr> | & <dataAccess> | <*;,)(\\ \\r\\n\\>?text> .\n"
    + " \n"
    + " \n"
    + " objExpr::= \n"
    ...
    + " | <checkTextExpr?textExpr>           ## It is a text assembled in runtime. \n"
    ...
    + " filesetAccess::= [ \n"
    + "                    <\"\"?accessPath> | <checkTextExpr?textExpr> \n"
