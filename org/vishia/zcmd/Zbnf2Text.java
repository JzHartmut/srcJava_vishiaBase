 ...
 * It uses a {@link JZtxtcmdScript} to describe the text generation and the {@link JZtxtcmdExecuter} to generate the text.
 * The translator from the generate control script is parsed with {@link JZtxtcmd} contained in this package.
...
public class Zbnf2Text extends Zbnf2Xml
{
  ...
  public interface PreparerParsedData{
    void prepareParsedData(XmlNode xmlResult, ZbnfParseResultItem zbnfResult, JZtxtcmdScript zgenscript, JZtxtcmdExecuter zgen);
  }
  ...
  PreparerParsedData setZbnfResult = new PreparerParsedData(){
    @Override public void prepareParsedData(XmlNode xmlResult, ZbnfParseResultItem zbnfResult, JZtxtcmdScript zgenscript, JZtxtcmdExecuter zgen)
    { try{ 
    ...
    if(bOk){
      ...
      for(Zbnf2Text.Out outArgs: args.listOut){
        ...
        try{ 
          ...
          //
          JZtxtcmdScript genScript = JZtxtcmd.translateAndSetGenCtrl(fileScript, checkXmlOutGenCtrl, console);
          //
