...
public final class JbatSyntax {
  ...
  public final static String syntax =
    ...
    + "$keywords= cmd | for | if | sub | main | call | break | java | javanew | String | Stringb | Obj | List | Pipe.\n"
    + "\n"
    + "\n"
    + "ZTextctrl::= \n"
    + "[<*|==jbat==?>==jbat== ]\n"
    ...
    + "\n"
    + "expression::={ <value> ? [! + | -] }.\n" //[! means: it should be given, but not processed by parser.
    + "\n"
    + "value::= [<?operator> + | - |] [<?unaryOperator> ! | ~ |]\n"
    + "   [<#?intValue> | 0x<#x?intValue> | <#f?floatValue> | '<!.?charValue>' | <\"\"?textValue> \n"
    + "   | \\<:\\><genContentNoWhitespace?genString>\\<\\.\\> \n" 
    + "   | javanew <newJavaClass> | [java |$!] <staticJavaMethod> | $$<$?envVariable> | <datapath>].\n"
    + "\n"
    //+ "objvalue::=\n"
    + "\n"
    ...
    + "\n"
    + "VarDef::= <$?name> [ = <expression>] ; [ onerror <onerror> ].\n"
    + "\n"
